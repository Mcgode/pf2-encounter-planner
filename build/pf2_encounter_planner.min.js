...
if (n > 4) return r.IMPOSSIBLE;
n >= -4 && (e += t.amount * s[n.toString()]);
}
return (e *= this.expectedPlayers / 4), e;
}
getEncounterRating() {
let e = this.getEncounterXpPerPlayer(),
t = 200,
n = null;
for (let o in i) t > i[o] && i[o] >= e && ((n = o), (t = i[o]));
...
let n = t.level - this.expectedLevel;
if (n > 4) return null;
n >= -4 && (e += t.amount * p[n.toString()] * (t.isComplex ? 5 : 1));
}
return e;
}
exportToJSON() {
...
break;
case t.HAZARD:
o.component = m.importFromJSON(e.component);
break;
case t.CUSTOM:
