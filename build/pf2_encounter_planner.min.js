...
class p {
constructor(e, t, n, r, s = null, o = null) {
(this.name = e),
(this.level = t),
(this.isComplex = n),
(this.amount = r),
...
break;
case t.CUSTOM:
r.component = h.importFromJSON(e.component);
}
return r;
}
}
...
(this.id = e), (this.players = t), (this.element = n), (this.levelUp = r || !1);
}
exportToJSON() {
return {
id: this.id,
...
for (let t of this.timelineEvents) e.timelineEvents.push(t.exportToJSON());
...
(s = null != this.params.players.find(e => e.id === r));
} while (s);
return this
...
let r,
s,
o = this.findElementById(t);
if (null == o) return null;
do {
(r = "event-" + Math.floor(Math.random() * Number.MAX_SAFE_INTEGER)),
(s = null != this.timelineEvents.find(e => e.id === r));
} while (s);
let i = new f(
r,
...
for (let e of t.timelineEvents) n.timelineEvents.push(f.importFromJSON(e, n));
return n;
}
