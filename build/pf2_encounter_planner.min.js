...
let t = 200,
n = null;
for (let s in o) t > o[s] && o[s] >= e && ((n = s), (t = o[s]));
...
s.component = i.importFromJSON(e.component);
break;
case t.HAZARD:
...
a = s.expectedLevel;
(s.expectedLevel = e),
(s.expectedPlayers = r.length),
s.getEncounterRating() === l.IMPOSSIBLE
? (this.errorEvents.push({event: n, reason: "Impossible encounter"}),
  (o = null))
: (o = s.getEncounterXpPerPlayer()),
(s.expectedLevel = a),
(s.expectedPlayers = i);
break;
case t.HAZARD:
...
m = s.expectedLevel;
(s.expectedLevel = p), (o = s.getEncounterXpPerPlayer()), (s.expectedLevel = m);
break;
default:
o = s.getEncounterXpPerPlayer();
}
(this.xpChange[n.id] = o), (o = o || 0);
for (let t of r)
this.playerHistory[t.id].push({index: e, xp: t.xp + o, level: t.level});
