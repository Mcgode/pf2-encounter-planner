...
if (null == e) return s.IMPOSSIBLE;
let t = 200,
n = null;
for (let l in i) t > i[l] && i[l] >= e && ((n = l), (t = i[l]));
return null == n ? s.IMPOSSIBLE : n;
}
exportToJSON() {
let e = {
type: t.FIGHT,
...
for (let n of e.creatures) t.creatures.push(l.importFromJSON(n));
return t;
}
getNewCreatureId() {
let e,
...
class l {
constructor(e, t, n, l = null, s = null) {
(this.name = e),
(this.level = t),
(this.amount = n),
(this.link = l),
...
static importFromJSON(e) {
return new l(e.name, e.level, e.amount, e.link, e.id);
}
}
const s = {
TRIVIAL: "trivial",
...
class m {
constructor(e, t, n, l, s = null, r = null) {
(this.name = e),
(this.level = t),
(this.isComplex = n),
(this.amount = l),
...
static importFromJSON(e) {
let l = new c(e.name);
if (((l.id = e.id), null != e.component))
switch (e.component.type) {
case t.FIGHT:
l.component = n.importFromJSON(e.component);
break;
case t.ACCOMPLISHMENT:
l.component = o.importFromJSON(e.component);
break;
case t.HAZARD:
l.component = p.importFromJSON(e.component);
break;
case t.CUSTOM:
l.component = h.importFromJSON(e.component);
}
return l;
}
}
...
class v {
constructor(e, t, n = null, l = !1, s = 0) {
(this.id = e),
(this.players = t),
(this.element = n),
(this.levelUp = l || !1),
(this.additionalNPCs = isNaN(s) ? 0 : parseInt(s));
}
exportToJSON() {
return {
id: this.id,
...
addEvent(e, t, n = !1) {
let l, s, r;
if (!n && ((l = session.findElementById(t)), null == l)) return null;
do {
(s = "event-" + Math.floor(Math.random() * Number.MAX_SAFE_INTEGER)),
(r = null != this.events.find(e => e.id === s));
} while (r);
let i = new v(
s,
...
if (n.levelUp) {
let t = !1;
for (let l of n.players) {
let n = this.playerHistory[l];
n &&
n.last().xp >= 1e3 &&
...
a = Math.max(...r.map(e => 1e3 * e.level + e.xp));
switch (l.type) {
case t.FIGHT:
...
a = l.expectedLevel;
(l.expectedLevel = e),
(l.expectedPlayers = r.length + n.additionalNPCs),
l.getEncounterRating() === s.IMPOSSIBLE
? (this.errorEvents.push({event: n, reason: "Impossible encounter"}),
  (i = null))
: (i = l.getEncounterXpPerPlayer()),
(l.expectedLevel = a),
(l.expectedPlayers = o);
break;
case t.HAZARD:
let p = this.session.getPlayerGroupLevel(r),
m = l.expectedLevel;
(l.expectedLevel = p), (i = l.getEncounterXpPerPlayer()), (l.expectedLevel = m);
break;
default:
i = l.getEncounterXpPerPlayer();
}
...
: i;
(n = Math.min(n, i + a - 1e3 * t.level - t.xp)),
...
let l, s;
do {
(l = "player-" + Math.floor(Math.random() * Number.MAX_SAFE_INTEGER)),
(s = null != this.params.players.find(e => e.id === l));
} while (s);
return this
.params.players[this.params.players.push({id: l, name: e, level: t, xp: n}) - 1];
}
...
for (let e of t.timelineEvents) l.push(v.importFromJSON(e, n));
return (n.timeline = new f(n, l)), n;
}
