...
let e = !1;
do {
let t = Math.floor(Number.MAX_SAFE_INTEGER * Math.random());
...
static importFromJSON(e) {
return new r(e.name, e.leadingComments, e.amount, e.link, e.id);
}
}
const o = {
TRIVIAL: "trivial",
...
for (let n of e.creatures) t.hazards.push(c.importFromJSON(n));
return t;
}
}
class c {
...
static importFromJSON(e) {
return new c(e.name, e.leadingComments, e.isComplex, e.amount, e.link);
}
}
const u = {
"-4": 2,
...
break;
case t.CUSTOM:
r.component = p.importFromJSON(e.component);
}
return r;
}
}
